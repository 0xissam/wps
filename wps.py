...
#            print("[!] Unexpected interference — kill NetworkManager/wpa_supplicant!")
    ...
    def __credentialPrint(self, wps_pin=None, wpa_psk=None, essid=None):
        print("")
        print(colored(f"[+] WPS PIN: '{wps_pin}'","cyan"))
        print(colored(f"[+] WPA PSK: '{wpa_psk}'","cyan"))
        print(colored(f"[+] AP SSID: '{essid}'","cyan"))
...
def usage():
    return """
wps pin developed by 0xissam_thr
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='wps pin developed by 0xissam_thr',
